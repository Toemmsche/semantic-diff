        ...
        for (const newNode of newNodes) {
            ...
            newNode.children.forEach((node) => {
                if (node.isMatched()) {
                    ...
                    if (match.getParent().label === newNode.label && !match.getParent().isMatched() && match.getParent().getParent() === parentMatch) {
            ...
            if ((leftSibling != null && !leftSibling.isMatched()) || (rightSibling != null && !rightSibling.isMatched())) {
                continue;
            }
            ...
            if (comparator.compareContent(potentialMatch, newNode) <= this.options.COMPARISON_THRESHOLD && !potentialMatch.isMatched()) {
